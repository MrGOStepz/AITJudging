<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateProjectDetail.aspx.cs" Inherits="AITAwards.UpdateProjectDetail" %>
                  ...
                  <div class="col-lg-12">
                      ...
                      <div class="card-body card-block">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group"><label for="typefile" class=" form-control-label">Type of file &nbsp&nbsp</label><asp:DropDownList ID="ddlTypeID" runat="server" CssClass="btn btn-secondary dropdown-toggle"></asp:DropDownList></div>
                        ...
                        <asp:Button ID="btnAddProject" runat="server" Text="Update Project" CssClass="btn btn-primary btn-lg btn-block" OnClick="btnUpdateProject_Click"/>
