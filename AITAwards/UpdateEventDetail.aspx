<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateEventDetail.aspx.cs" Inherits="AITAwards.UpdateEventDetail" %>
            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                            ...
                            <li><a href="UpdateEvent.aspx">Update Event</a></li>
                            <li class="active">Update Event Detail</li>
                        </ol>
                    </div>
                </div>
            </div>
