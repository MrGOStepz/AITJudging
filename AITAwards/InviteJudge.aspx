<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InviteJudge.aspx.cs" Inherits="AITAwards.InviteJudge" %>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Invite Judge</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header"><strong>Invite Judge</strong></div>
                      <div class="card-body card-block">
                        ...
                        <asp:Button ID="btnSendEmail" runat="server" Text="Send Invite" CssClass="btn btn-primary btn-lg btn-block" OnClick="btnSendEmail_Click"/>
