<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteProject.aspx.cs" Inherits="AITAwards.DeleteProject" %>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Delete Student Work</li>
                        </ol>
                    </div>
                </div>
            </div>
