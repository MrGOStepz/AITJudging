<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCategoryDetail.aspx.cs" Inherits="AITAwards.UpdateCategoryDetail" %>
<!doctype html>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Update Category Detail</li>
                        </ol>
                    </div>
                </div>
            </div>
