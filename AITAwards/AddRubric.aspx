<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddRubric.aspx.cs" Inherits="AITAwards.AddRubric" %>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                      <div class="card">
                      <div class="card-header"><strong>Add Rubric</strong></div>
                      <div class="card-body card-block">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group"><label for="criteria" class=" form-control-label">How many criteria?</label>
                              <asp:DropDownList ID="ddlCCriteria" runat="server" CssClass="btn btn-secondary dropdown-toggle"></asp:DropDownList>    
                              <asp:Button ID="btnAddCriteria" runat="server" Text="Create Criteria" CssClass="btn btn-primary" OnClick="btnAddCriteria_Click"/>
                          </div>

                          <div id="criteriaControl" runat="server">
                                <%--Create Criteria--%>
                              </div>
                

                        <asp:Button ID="btnAddRubric" runat="server" Text="Add Rubric" CssClass="btn btn-primary btn-lg btn-block" OnClick="btnAddRubric_Click"/>
